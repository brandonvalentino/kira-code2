...
description: "Deploy Kira Code Cloud on any server using Docker Compose"
---

This guide covers deploying Kira Code Cloud on any Linux server using Docker Compose. This approach works with any cloud provider (AWS, DigitalOcean, Hetzner, etc.) or on-premises server.
...
Clone the Kira Code repository:

```bash
git clone https://github.com/KairosUtamaIndonesia/kira-code.git
cd kira-code
```
...
2. You should see the Kira Code Cloud login page
