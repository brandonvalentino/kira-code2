...
description: "Run Kira Code Cloud locally"
---

This guide walks you through setting up a local Kira Code Cloud instance for development and testing.
...
3. Fill in the details:
   - **Application name**: Kira Code Local
...
Open [http://localhost:3000](http://localhost:3000) in your browser. You should see the Kira Code Cloud login page.
