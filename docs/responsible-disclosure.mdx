...
description: "How to report security vulnerabilities to Kira Code responsibly"
---

**Last updated:** *February 28, 2026*

At **Kira Code**, we take the security of our platform and the safety of
...
If you believe you've discovered a vulnerability in Kira Code that falls
...
- https://cloud.kira-code.kairos-it.com (remote server)
...
- Social engineering targeting Kira Code personnel
...
**Kira Code will not pursue legal action** against individuals reporting
vulnerabilities responsibly.

Researchers who submit valid and impactful reports may also receive
**recognition** or other discretionary rewards, at Kira Code's sole
discretion.
...
Kira Code may offer monetary rewards for qualifying vulnerability reports.
