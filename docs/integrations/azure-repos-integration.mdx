...
description: "Connect to Azure Repos to create pull requests and manage your workflow directly from Kira Code"
---

Kira Code integrates with Azure Repos to let you create pull requests directly from your task attempts. This integration relies on the [Azure CLI (`az`)](https://learn.microsoft.com/en-us/cli/azure/) with the Azure DevOps extension being installed and authenticated on your system.

## Setup

Before you can create pull requests from Kira Code, you need to install and configure the Azure CLI manually.
...
Kira Code supports both modern and legacy Azure DevOps URL formats:
