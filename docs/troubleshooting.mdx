...
description: "Common issues and solutions when using Kira Code"
---
...
If you encounter irrecoverable errors and need to completely wipe your Kira Code database, you can delete the application data directory for your operating system. 
...
<Tab title="macOS">
```bash
~/Library/Application Support/ai.kairos.kira-code/
```
</Tab>

<Tab title="Linux">
```bash
~/.local/share/kira-code/
```
</Tab>

<Tab title="Windows">
```
%APPDATA%\bloop\kira-code\
```

Typically: `C:\Users\<username>\AppData\Roaming\bloop\kira-code\`
</Tab>
</Tabs>

After deleting the application data directory, restart Kira Code to reset with an empty database and default settings.
