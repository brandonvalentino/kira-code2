...
When you add a repository to a workspace, Kira Code creates a **git worktree** - a separate working directory linked to your repository.
...
**Where worktrees are stored:** In the `.kira-code-workspaces` directory (configurable in Settings).
</Accordion>
