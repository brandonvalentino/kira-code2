...
icon: https://www.kira-code.kairos-it.com/images/logos/claude.svg#"
---
...
## Authentication
Authenticate and configure CCR outside of Kira Code. Follow the instructions on the CCR GitHub repo:
...
Kira Code does not ship a default configuration for CCR. Add configurations to the existing Claude Code agent:
...
### Example: Claude Code agent configuration in Kira Code

<Frame>
<img src="/images/vk-ccr-agent-config.png" alt="Claude Code agent configuration in Kira Code" />
</Frame>

## Using CCR in Kira Code
