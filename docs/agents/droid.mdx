...
icon: https://www.kira-code.kairos-it.com/images/logos/factory-ai-logo-light.png
---
...
<Step title="Authenticate with Factory AI">
  To use Droid in Kira Code, you must first authenticate:
...
Droid supports several configuration options in Kira Code:
...
These options can be configured when creating agent configurations in Kira Code.
