---
title: "Remote Access"
description: "Access your local Kira Code instance from another device"
---

Remote Access allows you to access a host instance of Kira Code from another device, like your mobile phone.

# 1. Launch Kira Code on the host device

Make sure you've started Kira Code and logged in.
...
# 3. Log into Kira Code cloud

On the client device where you'd now like to access your host machine from, navigate to [cloud.kira-code.kairos-it.com](https://cloud.kira-code.kairos-it.com) in a browser and log in.
...
<Frame>
  <img style={{maxHeight: "500px"}} src="/images/remote-access-cloud-mobile.png" alt="Kira Code cloud remote access page on mobile showing a paired host and workspaces" />
</Frame>
