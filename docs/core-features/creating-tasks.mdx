...
<Tip>
For detailed setup instructions and examples, see the [Kira Code MCP Server](/integrations/kira-code-mcp-server) documentation.
</Tip>
...
The MCP client will automatically generate structured tasks in your Kira Code project based on this description.
