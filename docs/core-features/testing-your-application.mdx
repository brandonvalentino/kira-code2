...
Preview Mode provides an embedded browser experience within Kira Code, allowing you to test and iterate on your web applications without leaving the development environment. This feature eliminates the need to switch between your browser and Kira Code by providing live preview capabilities and precise component selection tools.

**Key Benefits:**
- **Embedded viewing**: See your application running directly in Kira Code
...
<Step title="Install Web Companion">
  For precise component selection, install the `kira-code-web-companion` package in your application.

  <Info>
  **Recommended**: Use the "Install companion automatically" button in the Preview tab to have Kira Code create a task that installs and configures the companion for you.
  ...
  **Manual Installation:**
  ...
  ```bash
  npm install kira-code-web-companion
  ```
  ...
  <Tab title="Create React App">
    ...
    ```jsx
    import { VibeKanbanWebCompanion } from 'kira-code-web-companion';
...
3. **Interact with your app** directly within Kira Code
...
<Step title="Activate Selection Mode">
  Click the floating Kira Code companion button in the bottom-right corner of your application to activate component selection mode.
...
<Step title="Choose Component Depth">
  When you click a component, Kira Code shows a hierarchy of components from innermost to outermost. Select the appropriate level for your feedback:
...
- [Configuration & Customisation](/configuration-customisation/global-settings) - Customise Kira Code settings
