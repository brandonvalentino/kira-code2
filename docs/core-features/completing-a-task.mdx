...
description: "Learn how to complete tasks by rebasing, merging, and managing pull requests directly from Kira Code"
sidebarTitle: "Completing a Task"
---

When your task is finished, Kira Code provides integrated git operations to keep your branch up-to-date and merge your work back into the base branch.
