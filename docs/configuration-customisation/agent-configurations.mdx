...
<Info>
Agent profiles are used throughout Kira Code wherever agents run: onboarding, default settings, attempt creation, and follow-ups.
</Info>
...
<Note>
The configuration page displays the exact file path where your settings are stored. Kira Code saves only your overrides whilst preserving built-in defaults.
</Note>
...
<Card title="MCP Server Configuration" icon="server" href="/integrations/mcp-server-configuration">
  Configure MCP servers within Kira Code for your coding agents
</Card>

<Card title="Kira Code MCP Server" icon="plug" href="/integrations/kira-code-mcp-server">
  Connect external MCP clients to Kira Code's MCP server
</Card>
</CardGroup>
