---
title: "Kira Code Cloud"
description: "Collaborate with your team in real-time with Cloud features"
sidebarTitle: "Overview"
---

## What is Kira Code Cloud?

**Kira Code Cloud** adds team collaboration to Kira Code. Your projects, issues, and progress sync to the cloud so your entire team stays in sync.
...
<Card title="Same Interface" icon="desktop">
  Cloud uses the same Kira Code interface you already know. No new tools to learn.
</Card>
</CardGroup>
...
<Info>
You can use both Local and Cloud projects in the same Kira Code installation. They appear in separate sections of the sidebar.
</Info>

## How It Works

1. **Run Kira Code** as usual with `npx kira-code`
...
Think of it as your company or team in Kira Code.
...
- Review code directly in Kira Code
- Track PR status

## Getting Started

<Steps>
<Step title="Run Kira Code">
  ```bash
  npx kira-code
  ```
</Step>
