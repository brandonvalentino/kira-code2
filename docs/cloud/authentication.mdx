...
Kira Code Cloud uses OAuth authentication, allowing you to sign in with your existing GitHub or Google account instead of creating a new password.
...
OAuth is a secure way to sign in to applications using accounts you already have. When you click "Sign in with GitHub", you're redirected to GitHub to confirm you want to allow Kira Code access. GitHub then tells Kira Code who you are, without Kira Code ever seeing your GitHub password.
</Info>
...
<Step title="Authorise on Provider">
  ...
  Click **Authorize** (GitHub) or **Allow** (Google) to grant Kira Code access.
</Step>

<Step title="Redirected Back">
  After authorising, you're automatically redirected back to Kira Code and signed in.
</Step>
</Steps>

### What Kira Code Can Access

When you authorise Kira Code, it only requests minimal permissions:
...
2. Find "Kira Code Cloud" and revoke access
...
1. Sign out of Kira Code
2. Go to the provider's website (github.com or google.com)
3. Sign out there
4. Return to Kira Code and sign in - you'll be prompted to log in to the provider

## Security Best Practices

<CardGroup cols={2}>
<Card title="Use a strong provider password" icon="lock">
  Your Kira Code security depends on your GitHub/Google account security. Use a strong, unique password.
</Card>
...
2. If you're part of a GitHub organisation with app restrictions, ask your admin to approve Kira Code
</Accordion>
...
4. Return to Kira Code and sign in
</Accordion>
...
**Problem:** You revoked Kira Code's access on GitHub/Google and now can't sign in.
