...
description: "Solutions for common issues with Kira Code Cloud"
---

This page covers common issues you might encounter with Kira Code Cloud and how to resolve them.
...
4. Return to Kira Code and sign in again
</Accordion>
...
3. Try a different browser
4. Restart Kira Code (`npx kira-code`)
</Accordion>
...
1. **Check existing issues:** [github.com/KairosUtamaIndonesia/kira-code/issues](https://github.com/KairosUtamaIndonesia/kira-code/issues)
...
<Card title="Report an Issue" icon="github" href="https://github.com/KairosUtamaIndonesia/kira-code/issues/new">
