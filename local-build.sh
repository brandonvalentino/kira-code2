...
cargo build --release --bin kira-code-mcp --manifest-path Cargo.toml

echo "📦 Creating distribution package..."

# Copy the main binary
cp ${CARGO_TARGET_DIR}/release/server kira-code
zip -q kira-code.zip kira-code
rm -f kira-code 
mv kira-code.zip npx-cli/dist/$PLATFORM/kira-code.zip

# Copy the MCP binary
cp ${CARGO_TARGET_DIR}/release/kira-code-mcp kira-code-mcp
zip -q kira-code-mcp.zip kira-code-mcp
rm -f kira-code-mcp
mv kira-code-mcp.zip npx-cli/dist/$PLATFORM/kira-code-mcp.zip

# Copy the Review CLI binary
cp ${CARGO_TARGET_DIR}/release/review kira-code-review
zip -q kira-code-review.zip kira-code-review
rm -f kira-code-review
mv kira-code-review.zip npx-cli/dist/$PLATFORM/kira-code-review.zip

echo "✅ CLI build complete!"
echo "📁 Files created:"
echo "   - npx-cli/dist/$PLATFORM/kira-code.zip"
echo "   - npx-cli/dist/$PLATFORM/kira-code-mcp.zip"
echo "   - npx-cli/dist/$PLATFORM/kira-code-review.zip"
